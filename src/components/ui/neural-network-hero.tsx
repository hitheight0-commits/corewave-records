...
// We include a fallback to ensure the component doesn't crash if it's not available.
let SplitTextModules: any = null;
try {
    // Try to import it if it's available
    // In a real expert setup, we'd handle the plugin registration carefully
} catch (e) {
    console.warn("GSAP SplitText not found. Falling back to standard animations.");
}
